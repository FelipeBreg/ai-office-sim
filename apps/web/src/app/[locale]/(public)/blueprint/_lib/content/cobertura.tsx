...
const coverageData: DepartmentCoverage[] = [
  {
    ...
    rows: [
      ...
      },
      {
        ...
        complexidade: 'workflow',
        frequencia: 'semanal',
        recurso: 'Agente Jurídico + Approval nodes',
        observacao: 'Minutas + approval/condition nodes para fluxo completo',
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        complexidade: 'workflow',
        frequencia: 'mensal',
        recurso: 'Calendário Fiscal + Workflow templates',
        observacao: 'Calendário integrado + workflow templates + alertas escalonados',
      ...
      },
      {
        ...
        complexidade: 'integracao',
        frequencia: 'trimestral',
        recurso: 'Agente Contábil + Workflow',
        observacao: 'Validação pré-transmissão + calendário de prazos',
      ...
      },
      {
        ...
        complexidade: 'workflow',
        frequencia: 'mensal',
        recurso: 'Agente Fiscal + Workflow templates',
        observacao: 'Geração + conciliação automática via workflow engine + calendário',
    ...
    rows: [
      {
        ...
        complexidade: 'tarefa',
        frequencia: 'mensal',
        recurso: 'Agente Contador + Strategy KPI tools',
        observacao: 'Geração automática via strategy KPI tools + margens em tempo real',
    ...
    rows: [
      {
        ...
        complexidade: 'workflow',
        frequencia: 'por-demanda',
        recurso: 'Workflow templates + trigger_agent',
        observacao: 'Checklist + workflow completo com trigger por admissão',
      ...
      },
      {
        ...
        complexidade: 'integracao',
        frequencia: 'mensal',
        recurso: 'Agente RH + Workflow',
        observacao: 'Validação pré-envio + calendário de eventos periódicos',
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        complexidade: 'integracao',
        frequencia: 'diario',
        recurso: 'Agente Ads + Meta/Google Ads tools',
        observacao: 'Gerenciamento via Meta Ads + Google Ads tools integrados',
  ...
  },
  {
    ...
    rows: [
      ...
      },
      {
        ...
        complexidade: 'workflow',
        frequencia: 'mensal',
        recurso: 'Agente Qualidade + Condition/Approval nodes',
        observacao: 'Auditoria automática + NCs + approval nodes para revisão',
    ...
    rows: [
      {
        ...
        complexidade: 'workflow',
        frequencia: 'semanal',
        recurso: 'Agente Planejamento + Strategy KPI tools',
        observacao: 'Ciclos + check-ins + scoring via strategy KPI tools',
      ...
      },
      {
        ...
        complexidade: 'workflow',
        frequencia: 'anual',
        recurso: 'CEO briefing + Strategy KPI tools',
        observacao: 'Draft + cenários + KPIs via CEO briefing + strategy tools',
