...
function ApprovalBadge({ approval, note }: { approval: 'required' | 'auto'; note: string }) {
  const cfg = approval === 'required'
    ? { label: 'HUMAN APPROVAL', color: 'border-status-error text-status-error', icon: '\u26A0' }
    : { label: 'AUTO-EXECUTE', color: 'border-status-success text-status-success', icon: '\u2713' };
  return (
    <div className={`flex items-start gap-2 border ${cfg.color} p-2`}>
      <span className="text-[10px] font-bold shrink-0">{cfg.icon} {cfg.label}</span>
      <span className="text-[10px] text-text-muted">{note}</span>
    </div>
  );
}

function AgentCard({ process, status, agents, description, prompt, tools, rag, approval, approvalNote, pipeline }: AgentCardProps) {
  return (
    <div className="border border-border-default bg-bg-base p-4 space-y-3">
      ...
      <ApprovalBadge approval={approval} note={approvalNote} />
  ...
  <section>
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must submit to gov.br portal and sign documents"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Analysis/recommendation only — human makes final decision outside system"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Draft must be reviewed by lawyer before filing with Junta Comercial"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must submit documents to Junta portal and pay fees"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Monitoring and alerting only — human files with municipal/state portals"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Monitoring RPI only — human files petitions with INPI"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Contract must be approved by authority level before sending to counterparty"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Tax comparison only — human opts via Simples portal or first DARF"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review DAS calculation before generating payment guide"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review tax computation before generating DARFs"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review LALUR adjustments and tax computation before DARFs"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Invoice has legal validity — human must approve before SEFAZ transmission"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Calendar alerting only — human transmits filings via official portals"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must validate generated files with PVA before RFB transmission"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review reconciliation before generating payment guides"
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal report generation — no external action"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Real-time monitoring and projection — no external action"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve before sending invoices and collection messages to clients"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve payments above threshold before bank execution"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Auto-matches ~80% of transactions — unmatched items queued for human review"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal analysis and scenario generation — human approves budget externally"
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must verify documents and approve before eSocial registration"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal task assignment and notifications — no external-facing action"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review payroll calculations before processing payments"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve before submitting changes to benefit providers"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review before generating GRFGTS and INSS payment guides"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve vacation schedules and payment calculations"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve termination type, severance calculation, and TRCT"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must validate events before transmission to government portal"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Monitoring and alerting only — exams and reports done by external specialists"
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal CRM updates and reporting — no external-facing action"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Data enrichment and scoring only — no outbound contact initiated"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review proposal content and pricing before sending to prospect"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve contract terms before sending for signature"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve outreach messages before sending to prospects"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve retention offers and outreach before contacting customers"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Brand audit and validation only — no external publishing"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Analytics consolidation and reporting — no external action"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve post content before publishing to social platforms"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review and approve content before publishing or distributing"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Monitoring and suggestions only — human executes changes in ad platforms"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Audit, monitoring, and recommendations — no direct site modifications"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve campaign content and audience before sending"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Funnel analysis and internal lead tracking — no external action"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve purchase orders before sending to suppliers"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Inventory monitoring and alerting — reorder alerts go to human for action"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Shipment tracking and suggestions — no direct carrier API actions"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve CAPA assignments and non-conformity dispositions"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal documentation generation — published to company wiki only"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal dashboard and reporting — no external action"
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve responses before sending to customers"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal SLA monitoring and escalation alerts — no customer-facing action"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve resolution responses before sending to customers"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal routing between support tiers — no customer-facing action"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve survey content and timing before sending to customers"
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Monitoring and alerting — incident response actions create human tasks"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Security monitoring and alerting — remediation assigned to humans"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve before responding to data subject requests"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve PRs and deployment requests before execution"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve before deploying to production environments"
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Regulatory monitoring and mapping — no external filings"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must review and approve audit findings before distributing reports"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Risk analysis and dashboard generation — no external action"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Control testing and documentation — findings reviewed internally"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve due diligence results and investigation actions"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Cash position monitoring — sweep/investment actions require human execution"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve before generating and sending payment links to customers"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Credit analysis and scoring only — limit changes require human approval"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve before executing investment transactions"
      ...
      <AgentCard
        ...
        approval="required"
        approvalNote="Human must approve before sending collection messages and credit bureau actions"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
    ...
    <div className="mb-8 space-y-4">
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal OKR tracking and reporting — no external action"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal BSC tracking and dashboard — no external action"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Strategic analysis generation — internal document only"
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal strategic planning document — distributed to leadership only"
        prompt=""
        tools={[]}
        rag={[]}
        pipeline={[
      ...
      <AgentCard
        ...
        approval="auto"
        approvalNote="Internal meeting prep and minutes — distributed to board members only"
